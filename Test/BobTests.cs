...
public class BobTests
{
    ...
    {
        Assert.AreEqual("Whatever.", Bob.Response("Hi there!"));
    }

    [Test]
    public void Using_acronyms_in_regular_speech()
    {
        Assert.AreEqual("Whatever.", Bob.Response("It's OK if you don't want to go work for NASA."));
    }

    [Test]
    public void Forceful_question()
    {
        Assert.AreEqual("Calm down, I know what I'm doing!", Bob.Response("WHAT'S GOING ON?"));
    }
    ...
    {
        Assert.AreEqual("Whoa, chill out!", Bob.Response("I HATE THE DENTIST"));
    }
